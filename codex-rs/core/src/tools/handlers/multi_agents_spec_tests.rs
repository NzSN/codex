...
fn spawn_agent_tool_v2_requires_task_name_and_lists_visible_models() {
    ...
    let tool = create_spawn_agent_tool_v2(
        SpawnAgentToolOptions {
            ...
            message_delivery: codex_features::MultiAgentV2MessageDelivery::Encrypted,
        },
...
fn send_message_tool_requires_message_and_has_no_output_schema() {
    let ToolSpec::Function(ResponsesApiTool {
        ...
        output_schema,
        ..
    }) = create_send_message_tool(codex_features::MultiAgentV2MessageDelivery::Encrypted)
    else {
...
fn followup_task_tool_requires_message_and_has_no_output_schema() {
    let ToolSpec::Function(ResponsesApiTool {
        ...
        output_schema,
        ..
    }) = create_followup_task_tool(codex_features::MultiAgentV2MessageDelivery::Encrypted)
    else {
