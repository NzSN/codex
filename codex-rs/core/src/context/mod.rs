...
mod compatible_inter_agent_message;
...
mod inter_agent_authority_instructions;
...
pub(crate) use compatible_inter_agent_message::CompatibleInterAgentMessage;
...
pub(crate) use inter_agent_authority_instructions::InterAgentAuthorityInstructions;
